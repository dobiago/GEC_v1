            ...
            <div className="rounded-sm border border-slate-200 bg-[linear-gradient(135deg,rgba(58,0,30,0.96),rgba(90,10,50,0.88))] p-6 text-white shadow-[0_30px_90px_rgba(37,62,92,0.16)]">
              <div className="space-y-5">
                {contactHighlights.map((item) => (
                  <div key={item.label}>
                    <p className="text-xs uppercase tracking-[0.24em] text-amber-200">{item.label}</p>
                    <p className="mt-2 whitespace-pre-line text-base leading-7 text-white/78">{item.value}</p>
                  </div>
                ))}
              </div>
            </div>

            <div className="hidden rounded-sm border border-slate-200 bg-[linear-gradient(135deg,rgba(58,0,30,0.96),rgba(90,10,50,0.88))] p-6 text-white shadow-[0_30px_90px_rgba(37,62,92,0.16)]">
