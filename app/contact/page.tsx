      ...
      <section className="px-6 pb-20 pt-16 md:px-12 md:pb-24 md:pt-20">
        <div className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr]">
          <div className="space-y-8">
            ...
            <div className="rounded-[32px] border border-slate-200 bg-white/90 p-6 shadow-[0_30px_80px_rgba(37,62,92,0.08)]">
            ...
            <div className="rounded-[32px] border border-slate-200 bg-[linear-gradient(135deg,rgba(10,37,64,0.96),rgba(14,116,144,0.88))] p-6 text-white shadow-[0_30px_90px_rgba(37,62,92,0.16)]">
