...
export function AboutTeamDetail({ bio, imageSrc, name, title }: AboutTeamDetailProps) {
  return (
    <main className="w-full pt-28 text-slate-900">
      <section className="grid w-full gap-10 px-6 pb-20 md:px-12 lg:min-h-[calc(100vh-8rem)] lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
        ...
        <div className="lg:sticky lg:top-32">
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[32px] border border-slate-200 bg-[radial-gradient(circle_at_top,rgba(14,116,144,0.18),transparent_45%),linear-gradient(135deg,#f8fafc,#e2e8f0)] shadow-[0_30px_80px_rgba(37,62,92,0.08)]">
            {imageSrc ? (
              <Image
                src={imageSrc}
                alt={name}
